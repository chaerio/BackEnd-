...
//		for(OrderItemDTO oit : ord.getOrders()) {
//			OrderItemDTO orderAlbums = new OrderItemDTO();
//			
//			orderAlbums = orderMapper.getOrderAlbumsInfo(oit.getProductNum());
//	
//			// 수량 셋팅
//			orderAlbums.setAmount(oit.getAmount());
//			// 기본 정보 셋팅
//			orderAlbums.initTotal();
//			// List객체 추가
//			ords.add(orderAlbums);
//		}
